  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        {orders.length === 0 ? (
          <div className="card text-center py-12 text-gray-500">No orders placed yet.</div>
        ) : (
          <div className="card overflow-hidden p-0">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  {['Order ID','Listing','Quantity','Status','Placed On'].map((h) => (
              ...
              <tbody className="divide-y divide-gray-100">
                {orders.map((o) => (
                  <tr key={o.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 font-mono text-xs text-gray-400">{o.listingId.slice(0,8)}…</td>
